...
import { createCustomerList } from "../../src/services/customer.service";
...
function AdminAddCustomer() {
  ...
  async function addCustomer() {
    try {
      ...
      console.log(payload);
      const customerList = await createCustomerList(payload);
        ...
        <div className="AdContent">
          ...
          <div className="adRightContent">
            <div className="pathSec">
              ...
              <div className="path">
                Admin &gt; Contacts &gt; <span> Add Contact</span>
              </div>
            </div>
            {/* add tag form */}
            <div className="formDiv">
              <div className="row">
                <div className="col-lg-8">
                  <div className="formTitle">Add Contact</div>
                  <div className="form">
                    <div className="inBox">
